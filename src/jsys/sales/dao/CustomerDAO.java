...
public class CustomerDAO {
	...
	// 得意先情報を削除する処理(delete_flagをtrueに変える)
	public Customer deleteCustomer(String customerCode) throws SQLException {
	...
	public Customer insertCustomer(Customer customer) throws SQLException {
		...
		try {
			...
			stmt.setString(4, customer.getCustomerTelno());
			stmt.setString(5, customer.getCustomerPostalcode());
			stmt.setString(6, customer.getCustomerAddress());
			stmt.setInt(7, customer.getDiscountRate());
